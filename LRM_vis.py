...
all_bounds = {	'actual': times_LRM[1:]*1000,
			...
			'sub_1': sub_1_tau_bounds_omega*1000,
			'sub_2': sub_2_tau_bounds_beta*1000,
			'sub_3': sub_3_tau_bounds_phi*1000,
			'sub_4': sub_4_tau_bounds_alpha*1000,
...
# ************************************************************
# the below would need to be changed to subsystem contributions to each unit
